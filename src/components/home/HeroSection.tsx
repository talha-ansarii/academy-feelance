...
export function HeroSection() {
  return (
    <section className="relative flex min-h-[85vh] items-center px-6 py-20 lg:py-0 overflow-hidden bg-white">
      ...
      <div className="max-w-[75rem] mx-auto grid lg:grid-cols-[1.2fr_0.8fr] gap-16 items-center w-full">
        <motion.div 
          initial="hidden"
          animate="visible"
          variants={stagger}
        ...
        >
          ...
          <motion.h1 variants={fadeUp} className="font-headline text-5xl md:text-6xl lg:text-[4rem] font-extrabold leading-[1.1] text-slate-900 tracking-tight mb-8">
          ...
          <motion.p variants={fadeUp} className="text-slate-600 text-lg md:text-xl leading-relaxed mb-10 max-w-xl">
        ...
        >
          ...
          <div className="max-w-[340px] w-full rounded-2xl p-6 shadow-[0_20px_50px_rgba(0,0,0,0.06)] bg-white/80 backdrop-blur-xl border border-slate-100 relative group transition-transform duration-500 hover:-translate-y-2">
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-slate-500 text-[0.7rem] font-medium leading-relaxed">Ex-Head Faculty at Aakash Institute<br/>& Target PMT</p>
              </div>
